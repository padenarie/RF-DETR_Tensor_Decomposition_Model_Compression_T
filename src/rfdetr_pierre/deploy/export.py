...
from rfdetr_pierre.datasets.transforms import Normalize
from rfdetr_pierre.models import build_model
from rfdetr_pierre.util.logger import get_logger
from rfdetr_pierre.util.misc import get_rank, get_sha
from rfdetr_pierre.util.package import get_version
...
def onnx_simplify(onnx_dir: str, input_names, input_tensors, force=False):
    ...
    from rfdetr_pierre.deploy._onnx import OnnxOptimizer
