...
from rfdetr_pierre.datasets.coco import compute_multi_scale_scales
from rfdetr_pierre.datasets.coco_eval import CocoEvaluator
from rfdetr_pierre.util.logger import get_logger
from rfdetr_pierre.util.misc import get_world_size
...
from rfdetr_pierre.util.misc import NestedTensor
