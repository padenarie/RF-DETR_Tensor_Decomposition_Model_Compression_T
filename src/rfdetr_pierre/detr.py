...
from rfdetr_pierre.datasets.coco import is_valid_coco_dataset
from rfdetr_pierre.datasets.yolo import is_valid_yolo_dataset
...
from rfdetr_pierre.assets.model_weights import download_pretrain_weights
from rfdetr_pierre.config import (
    ModelConfig,
    RFDETRBaseConfig,
    RFDETRLargeConfig,
...
from rfdetr_pierre.main import Model
from rfdetr_pierre.util.coco_classes import COCO_CLASSES
from rfdetr_pierre.util.metrics import (
    MetricsClearMLSink,
    MetricsMLFlowSink,
    MetricsPlotSink,
...
####---------------------------------------------------
    ...
    def tt_factorize(
        ...
        Usage:
            model = RFDETRSegNano()
            model = model.tt_factorize(eps=0.01, layer_ids=[7, 8, 9, 10, 11])
        """
...
####---------------------------------------------------
# END OF INSERTED BY P.DENARIE FOR TT BACKED MLP LAYERS
####---------------------------------------------------
    ...
    def train_from_config(self, config: TrainConfig, **kwargs):
        ...
        if config.early_stopping:
            from rfdetr_pierre.util.early_stopping import EarlyStoppingCallback
